...
public class BestSeller {
    ...
    public void checkAppsAndGamesLink(){
        ...
        driver.findElement(By.linkText("Books & Comics")).click();
    ...
    public void checkElectronicsLink(){
        ...
        driver.findElement(By.linkText("Office Electronics")).click();
    }
    ...
    @Test
    public void checkPrimeReadingLink(){
        driver.findElement(By.linkText("Kindle Books")).click();
        driver.findElement(By.linkText("Prime Reading")).click();
    }
    @Test
    ...
    public void checkBeautyAndPersonalCare(){
        ...
        driver.findElement(By.linkText("Fragrance")).click();
    }
    @Test
